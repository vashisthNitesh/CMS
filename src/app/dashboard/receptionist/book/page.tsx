...
export default function BookAppointmentPage() {
    ...
    async function handleBooking() {
        ...
        startTransition(async () => {
            ...
            if (result.error) {
                ...
                setTimeout(() => router.push("/dashboard/receptionist"), 1500);
            }
        });
    }
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6 pb-20">
            <div className="mb-4">
                <Button variant="ghost" onClick={() => router.push("/dashboard/receptionist")} className="-ml-4 text-slate-400 hover:text-white">
